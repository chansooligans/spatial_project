...
```{r}
center = high_stops_center[1,c('lon','lat')]

# Radius
radius = 0.01

# Distances between Center and All Stops
distances = sqrt((df$lon - center$lon)^ 2 + (df$lat - center$lat)^ 2)
...
plot(density(hit_rate), main = 'Sampling Distribution of Hit Rates')
